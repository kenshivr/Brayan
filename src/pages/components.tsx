...
function useNeumorphismColors() {
  const { themes, selectedPalette } = useThemeStore();
  const baseColor = themes[selectedPalette].fifthColor;
  ...
  return {
    ...
    COLORS: {
      ...
      insetDarkShadow: applyVectorToHex(
        baseColor,
        vectorInsetDarkShadow,
        "0.25"
      ),
      insetLightShadow: applyVectorToHex(baseColor, vectorInsetLightShadow),
      neumorphismInsetLight: applyVectorToHex(
        baseColor,
        vectorInsetLightShadow,
        "0.9"
      ),
      neumorphismInsetDark: applyVectorToHex(
        baseColor,
        vectorNeumorphismInsetDark,
        "0.8"
      ),
...
export const Neumorphism0: React.FC<NeumorphismProps> = ({ className }) => {
  const { baseColor, COLORS } = useNeumorphismColors();
  return (
    <div
      className={cn(
...
export const Neumorphism6: React.FC<NeumorphismProps> = ({
  className,
  children,
}) => {
  const { baseColor, COLORS } = useNeumorphismColors();
...
export const Neumorphism7: React.FC = () => (
  <Neumorphism6 className="flex justify-center items-center w-[300px] h-[300px]">
    <Neumorphism6 className="flex justify-center items-center w-[200px] h-[200px]">
      <Neumorphism6 className="flex justify-center items-center w-[100px] h-[100px]" />
    </Neumorphism6>
  </Neumorphism6>
);

export const Neumorphism8: React.FC<NeumorphismProps> = ({
  className,
  children,
}) => {
  const { baseColor, COLORS } = useNeumorphismColors();
...
export const Neumorphism9: React.FC = () => (
  <Neumorphism8 className="flex justify-center items-center w-[300px] h-[300px]">
    <Neumorphism8 className="flex justify-center items-center w-[200px] h-[200px]">
      <Neumorphism8 className="flex justify-center items-center w-[100px] h-[100px]" />
    </Neumorphism8>
  </Neumorphism8>
);

export const Neumorphism10: React.FC<NeumorphismProps> = ({
  className,
  children,
}) => {
  const { baseColor, COLORS } = useNeumorphismColors();
...
export const Neumorphism11: React.FC<NeumorphismProps> = ({
  className,
  children,
}) => {
  const { baseColor, COLORS } = useNeumorphismColors();
...
export const Neumorphism12: React.FC<NeumorphismProps> = ({
  className,
  children,
}) => {
  const { baseColor, COLORS } = useNeumorphismColors();
...
export const Neumorphism13: React.FC<NeumorphismProps> = ({
  className,
  children,
}) => {
  const { baseColor, COLORS } = useNeumorphismColors();
...
export const Neumorphism14 = Neumorphism13;

export const Neumorphism16: React.FC<NeumorphismProps> = ({
  className,
  children,
}) => {
  const { baseColor, COLORS } = useNeumorphismColors();
...
export const Neumorphism17: React.FC<NeumorphismProps> = ({
  className,
  children,
}) => {
  const { baseColor, COLORS } = useNeumorphismColors();
  return (
    <div
      className={cn(
        "rounded-full w-[300px] h-[300px] flex justify-center items-center",
        className
      )}
      style={{
        backgroundColor: baseColor,
...
export default function Components({
  ...
  const { baseColor } = useNeumorphismColors();
  return (
    <>
      <Menu isDesktop={true} />
      <div
